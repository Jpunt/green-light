...
- You want to use Jasmine, Karma, CasperJS, RSpec, PhantomJS, Nightwatch, NodeUnit, Sinon, Cucumber, ZombieJS, Selenium, JUnit, or whatever. GreenLight works with Mocha, Chai, JSDom and MockedApi. These tools are great and support for anything else is not worth the complexity.
